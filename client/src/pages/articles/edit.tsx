...
export default function ArticleEditPage() {
  ...
  useEffect(() => {
    if (articleData) {
      ...
      if (typeof formData.readingTime === 'string') {
  ...
  return (
    <DashLayout
      ...
      description={isNewArticle 
        ...
        : `Editing article: ${form.watch('title')}`}
    >
      <Button
        variant="outline"
        className="mb-6"
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter the basic details for this article
                </CardDescription>
              </CardHeader>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Used for the article URL (automatically generated)
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        A brief excerpt that will appear in article listings
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Enter the main content for this article
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        The beginning of the article content (supports HTML)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        The end of the article content (supports HTML)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        The main thumbnail image for this article
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Images that will be used within the article content
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>
                            Display as a large featured article on the home page
                          </FormDescription>
                        </div>
                        <FormControl>
                          <Switch
